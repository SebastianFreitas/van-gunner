...
- Never read a whole script over 300 lines. Over 500 today: `scripts/travel/travel_controller.gd` (1311), `scripts/van/van.gd` (1155), `scripts/van/van_side_wall.gd` (1110), `scripts/stops/shop_counter_booth.gd` (1012), `scripts/core/game_session.gd` (910), `scripts/debug/debug_commands.gd` (754), `scripts/ui/bench_screen.gd` (719), `scripts/enemies/window_raider.gd` (680), `scripts/travel/road_floor.gd` (608), `scripts/ui/act_reveal_panel.gd` (580), `scripts/van/side_doors.gd` (557). Grep `-n` for the function name, then Read with offset and limit. Function names don't drift; line numbers do.
