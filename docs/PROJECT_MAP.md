...
**`.claude/worktrees/continue-previous-work-605228/scenes/corridor/corridor_segment.gd`**

- `enum Opening { NONE, SIDE_STREET, BAY }`

**`.claude/worktrees/continue-previous-work-605228/scripts/acts/act_card_definition.gd`**

- `enum Polarity { BLESSING = 0, DANGER = 1, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/acts/act_deck_controller.gd`**

- `signal reveal_resolved`
- `signal boss_pick_resolved`

**`.claude/worktrees/continue-previous-work-605228/scripts/acts/boon_reward_controller.gd`**

- `signal rest_resolved`

**`.claude/worktrees/continue-previous-work-605228/scripts/classes/class_definition.gd`**

- `enum Family { BASIC, SHOTGUN, MACHINEGUN, SNIPER }`

**`.claude/worktrees/continue-previous-work-605228/scripts/combat/grenade.gd`**

- `signal exploded(world_position: Vector3)`

**`.claude/worktrees/continue-previous-work-605228/scripts/combat/gun_controller.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/combat/gun_stats_controller.gd`**

- `signal stats_changed`

**`.claude/worktrees/continue-previous-work-605228/scripts/combat/projectile.gd`**

- `signal hit_target(target: Node)`
- `signal ricocheted(position: Vector3, normal: Vector3)`
- `signal despawned(was_hit: bool)`

**`.claude/worktrees/continue-previous-work-605228/scripts/combat/stat_modifier.gd`**

- `enum Mode { ADD, MULTIPLY, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/core/game_session.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/core/loot_collector.gd`**

- `signal queue_changed`

**`.claude/worktrees/continue-previous-work-605228/scripts/core/meta_progression.gd`**

- `signal van_speed_changed(level: int, speed: float)`
- `signal rare_parts_changed(total: int)`
- `signal tree_changed`

**`.claude/worktrees/continue-previous-work-605228/scripts/enemies/biker_boss.gd`**

- `enum BikePhase { IDLE, CHARGE, WINDUP, PEEL, WEAVE, ENTERING, BENCH }`

**`.claude/worktrees/continue-previous-work-605228/scripts/enemies/breach_point.gd`**

- `signal breached`
- `signal health_changed(current: float, maximum: float)`
- `enum Kind { REAR_DOOR, SIDE_DOOR, WINDOW, SIDE_DOOR_WINDOW }`

**`.claude/worktrees/continue-previous-work-605228/scripts/enemies/cabin_nav.gd`**

- `enum Room { BACK, CABIN }`

**`.claude/worktrees/continue-previous-work-605228/scripts/enemies/window_raider.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/interactions/class_board.gd`**

- `signal opened`

**`.claude/worktrees/continue-previous-work-605228/scripts/interactions/crafting_table.gd`**

- `signal opened`

**`.claude/worktrees/continue-previous-work-605228/scripts/interactions/request_board.gd`**

- `signal opened`

**`.claude/worktrees/continue-previous-work-605228/scripts/items/item_definition.gd`**

- `enum ItemKind { MONEY = 0, BOON = 1, TOOL = 2, CONSUMABLE = 3, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/items/item_usable_config.gd`**

- `enum RechargeMode { NONE, COOLDOWN, ON_KILL, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/items/pickup.gd`**

- `enum _AnimState { SPIN, FACE }`

**`.claude/worktrees/continue-previous-work-605228/scripts/meta/skill_node_definition.gd`**

- `enum Branch { ORIGIN = 0, UP = 1, DOWN = 2, LEFT = 3, RIGHT = 4, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/player/boon_traits.gd`**

- `signal traits_changed`

**`.claude/worktrees/continue-previous-work-605228/scripts/player/fps_player.gd`**

- `signal interaction_prompt_changed(text: String)`
- `signal shot_fired(hit: bool)`

**`.claude/worktrees/continue-previous-work-605228/scripts/player/usables_controller.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/stops/side_stop_definition.gd`**

- `enum Arrival { REAR_PARK = 0, ELEVATOR = 1, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/stops/warehouse_hide.gd`**

- `signal triggered`
- `enum Reveal { BURST, FALL, PEEL }`

**`.claude/worktrees/continue-previous-work-605228/scripts/stops/warehouse_laser.gd`**

- `signal sprung`

**`.claude/worktrees/continue-previous-work-605228/scripts/travel/travel_controller.gd`**

- `enum TurnState { NONE, APPROACHING, TURNING, PARKING, LEAVING_STOP, ELEVATING, }`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/act_reveal_panel.gd`**

- `signal reveal_finished`
- `signal boss_cards_picked(card_ids: Array)`
- `enum Mode { ACT_REVEAL, BOSS_PICK }`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/bench_screen.gd`**

- `signal closed`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/boon_choice_panel.gd`**

- `signal choice_made(item: ItemDefinition)`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/class_panel.gd`**

- `signal closed`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/debug_console.gd`**

- `signal opened`
- `signal closed`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/driver_shout_hud.gd`**

- `signal boost_pressed`
- `signal slow_pressed`

**`.claude/worktrees/continue-previous-work-605228/scripts/ui/pause_menu.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/ui/skill_tree_hud.gd`**

- `signal closed`

**`.claude/worktrees/continue-previous-work-605228/scripts/van/breakable_glass.gd`**

- `signal shattered`

**`.claude/worktrees/continue-previous-work-605228/scripts/van/rear_doors.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/van/side_doors.gd`**
...
**`.claude/worktrees/continue-previous-work-605228/scripts/van/side_windows.gd`**

- `signal opened`
- `signal closed`
- `signal window_changed(window_id: StringName, is_open: bool)`

**`.claude/worktrees/continue-previous-work-605228/scripts/van/van_bulkhead.gd`**

- `enum OpeningSide { LEFT, RIGHT }`

**`.claude/worktrees/continue-previous-work-605228/scripts/van/van_vital.gd`**
...
474 GDScript files, 68264 lines.

### `.claude/worktrees/continue-previous-work-605228/scenes/corridor/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/acts/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/acts/effects/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/audio/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/classes/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/combat/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/core/`
...
| `game_session.gd` | — | 362 | Autoload: tracks run phase, van/player health, route and wave state for the current run. |
...
### `.claude/worktrees/continue-previous-work-605228/scripts/debug/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/dialogue/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/enemies/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/interactions/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/items/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/items/effects/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/meta/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/meta/effects/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/player/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/stops/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/travel/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/travel/facades/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/travel/facades/set_pieces/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/ui/`
...
### `.claude/worktrees/continue-previous-work-605228/scripts/van/`
...
| `van.gd` | — | 391 | Van root script: wires up the van's HUD, overlays, act deck and route choices. |
...
| `van_lighting.gd` | `VanLighting` | 49 | Marks van interior meshes as render layer 2 so DoorSpill (cull mask layer 1) lights the corridor through openings without washing the cabin. |
...
### `.claude/worktrees/continue-previous-work-605228/tools/`

| File | class_name | LOC | Summary |
|---|---|---|---|
| `check_scripts.gd` | — | 45 | Headless load check. |

### `.claude/worktrees/continue-previous-work-605228/tools/scene_dump/`

| File | class_name | LOC | Summary |
|---|---|---|---|
| `scene_dump.gd` | — | 148 | Headless dump of an instantiated scene's nodes, properties, resources and connections for diffing. |

### `.claude/worktrees/continue-previous-work-605228/tools/smoke/`
...
| File | class_name | LOC | Summary |
|---|---|---|---|
| `smoke_driver.gd` | — | 341 | Drives a full headless playthrough of one van run to prove the game boots, the class/boon/rest UI flows work end to end, and the balance numbers stay determini… |
| `smoke_fingerprint.gd` | — | 106 | Static helpers that build the smoke driver's fingerprint lines (class stats, pools, act deck, waves, rest offer) and write them to user://. |
| `smoke_route.gd` | — | 157 | Drives the fork/side-stop portion of the smoke run (route.gd -> route choice -> stop -> back to travelling). |
| `smoke_test.gd` | — | 13 | Headless smoke test entry scene. |
...
|---|---|---|
| `.claude/worktrees/continue-previous-work-605228/scenes/boot/boot.tscn` | 3 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/combat/projectile.tscn` | 4 | Area3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/act_statue.tscn` | 4 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/corridor_crossroads.tscn` | 21 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/corridor_segment.tscn` | 11 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/corridor_t_junction.tscn` | 17 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/garage_bay.tscn` | 14 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/mechanic_bay.tscn` | 19 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/road_floor.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/shop_bay.tscn` | 23 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/side_street_branch.tscn` | 2 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/stop_elevator.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/stop_vestibule.tscn` | 4 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/corridor/warehouse_bay.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/enemies/biker_boss.tscn` | 2 |  |
| `.claude/worktrees/continue-previous-work-605228/scenes/enemies/window_raider.tscn` | 9 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/items/pickup.tscn` | 3 | Area3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/player/player.tscn` | 13 | CharacterBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/shop/shop_offer.tscn` | 3 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/bench_screen.tscn` | 24 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/damage_number.tscn` | 1 | Label |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/debug_console.tscn` | 8 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/driver_shout_hud.tscn` | 9 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/item_hud.tscn` | 7 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/main_menu.tscn` | 25 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/pause_menu.tscn` | 22 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/run_hud.tscn` | 43 | CanvasLayer |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/skill_tree_hud.tscn` | 19 | Control |
| `.claude/worktrees/continue-previous-work-605228/scenes/ui/usable_slot.tscn` | 6 | PanelContainer |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/broken_iron_cross.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/class_board.tscn` | 4 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/iron_cross.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/loot_machine.tscn` | 9 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/request_board.tscn` | 4 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van.tscn` | 56 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_breach_points.tscn` | 32 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_bulkhead.tscn` | 1 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_ceiling.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_floor.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_shell.tscn` | 184 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_side_wall.tscn` | 1 | Node3D |
| `.claude/worktrees/continue-previous-work-605228/scenes/van/van_vital_dummy.tscn` | 5 | StaticBody3D |
| `.claude/worktrees/continue-previous-work-605228/tools/scene_dump/scene_dump.tscn` | 1 | Node |
| `.claude/worktrees/continue-previous-work-605228/tools/smoke/smoke_test.tscn` | 1 | Node |
...
`.claude/worktrees/continue-previous-work-605228/scenes/corridor/asphalt_surface.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/corridor/facade_marquee.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/corridor/facade_sign.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/corridor/facade_surface.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/corridor/industrial_surface.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/corridor/sidewalk_surface.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/van/van_ceiling.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/van/van_floor.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/van/van_floor_mat.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/van/van_floor_paper.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/van/van_viga.gdshader`, `.claude/worktrees/continue-previous-work-605228/scenes/van/van_wall.gdshader`, `scenes/corridor/asphalt_surface.gdshader`, `scenes/corridor/facade_marquee.gdshader`, `scenes/corridor/facade_sign.gdshader`, `scenes/corridor/facade_surface.gdshader`, `scenes/corridor/industrial_surface.gdshader`, `scenes/corridor/sidewalk_surface.gdshader`, `scenes/van/van_ceiling.gdshader`, `scenes/van/van_floor.gdshader`, `scenes/van/van_floor_mat.gdshader`, `scenes/van/van_floor_paper.gdshader`, `scenes/van/van_viga.gdshader`, `scenes/van/van_wall.gdshader`
